...
UBIDOTS_API_KEY = "BBUS-1cgggIUhARAaKmNebzojrctnjyp1wY"
UBIDOTS_DEVICE_ID = "655a5d18c50051000e8ff1c8"
UBIDOTS_VARIABLE_ID = "655a809979b8d4000d88b743"
...
def send_ubidots_data_in_thread(value_to_send):
    def send_data():
        ...
        if response.status_code == 201:
            ...
            print(
                f"Lỗi khi gửi dữ liệu lên Ubidots. Mã trạng thái: {response.status_code}"
            )
